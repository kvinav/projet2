      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p> Publié par <em><?php echo $postunique->getAuthor($post); ?> </em><p>
            <?php if ($postunique->getDatepost() == $postunique->getDatemodif()) { 
             ...
             <a href="../CONTROLER/controlermodifbillet.php?id=<?php echo $postunique->getId(); ?>&modifier"><input type="submit" class="btn btn-primary submit" value="Modifier"></a>  <a href="../CONTROLER/controleradminbillet.php?id=<?php echo $postunique->getId(); ?>&supprimerbill"><input type="submit" class="btn btn-danger submit" value="Supprimer" OnClick="return confirm('Voulez-vous vraiment supprimer ?');"></a> <br><br><br>
        ...
        <ul class="lis-group">
          <li class="list-group-item"><p><strong><?php echo $comment->getPseudo(); ?></strong> - <em>le <?php echo $comment->getDatecomment(); ?></em></p>
              ...
              <a href="../CONTROLER/controleradminbillet.php?id=<?php echo $comment->getId(); ?>&supprimercom"><input type="submit" class="btn btn-danger submit" value="Supprimer" OnClick="return confirm('Voulez-vous vraiment supprimer ?');"></a>
